...
const DOMManager = (function () {
  ...
  function addTask(task) {
    ...
    actions.innerHTML =
      "<button class='chevron collapsed' data-toggle='collapse' data-target=''><i class='fas fa-chevron-down'></i><button class='edit-btn' data-toggle='modal' data-target='#input-window'><i class='fas fa-edit'></i></button><button class='del-btn'><i class='fas fa-trash-alt'></i></button>";
    ...
    chevron.addEventListener("animationend", (e) => {
      if (e.animationName === "rotate-down")
        e.target.classList.remove("rotate-down");
    });
  ...
  projModalBtn.addEventListener("click", () => {
    ...
    if (!project || projectManager.projects.includes(project.toLowerCase()))
      return;
